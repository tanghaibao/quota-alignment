...
5)
cluster_utils.py --maf data/al_scaffold_1_vs_at_chr_1.maf data/al_scaffold_1_vs_at_chr_1.qa
quota_align.py --merge --Dm 40000 --quota 1:1 --Nm 10000 data/al_scaffold_1_vs_at_chr_1.qa
