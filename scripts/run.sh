...
#../cluster_utils.py --format=raw ~/blast/results/athaliana_grape.filtered.raw athaliana_grape.qa
#../quota_align.py --merge --Dm=20 --min_size=5 --quota=4:1 athaliana_grape.qa
python plot_qa.py --qbed=athaliana.filtered.bed --sbed=grape.filtered.bed athaliana_grape.qa.filtered
